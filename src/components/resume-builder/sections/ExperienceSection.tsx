                      ...
                      >
                        <div className="px-4 py-4 space-y-5">
                          ...
                          <div>
                            ...
                            {expAIError && (
                              <div className="flex items-start gap-2 p-2.5 rounded-lg bg-red-500/10 border border-red-500/20 mb-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-[11px] text-red-300">{expAIError}</p>
                                  {expAIError.includes("limit") && (
                                    <a href="/pricing" className="text-[10px] text-cyan-400 hover:text-cyan-300 mt-1 inline-block">
                                      Upgrade to Professional for unlimited AI →
                                    </a>
                                  )}
                                </div>
                              </div>
