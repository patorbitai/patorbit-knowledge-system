...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return <h3 className="text-[11px] font-bold text-slate-300 uppercase tracking-[0.15em] mb-4">{children}</h3>;
}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* Section nav */}
        <nav className="w-[260px] shrink-0 border-r border-white/[0.06] bg-[#080C18] overflow-y-auto py-5 px-3 space-y-1">
      ...
      <footer className="h-14 shrink-0 border-t border-white/[0.06] bg-[#080C18] flex items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-6 py-2.5 rounded-lg text-[13px] font-semibold bg-blue-500 text-white hover:bg-blue-600 transition-all shadow-lg shadow-blue-500/20"
          >
            Continue to Builder
