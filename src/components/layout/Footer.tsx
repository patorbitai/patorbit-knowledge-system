        ...
        <div className="grid lg:grid-cols-5 gap-10 pb-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="https://twitter.com/patorbit" target="_blank" rel="noopener noreferrer" aria-label="Patorbit on X (Twitter)" className="flex h-8 w-8 items-center justify-center rounded-lg border border-white/[0.08] bg-white/[0.03] hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all group">
                <svg className="w-3.5 h-3.5 text-slate-400 group-hover:text-cyan-400 transition-colors" viewBox="0 0 24 24" fill="currentColor">
