      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2 rounded-lg bg-gray-50 dark:bg-white/[0.03] border border-gray-100 dark:border-white/[0.04] px-3 py-2">
            <span className="flex h-5 w-5 items-center justify-center rounded-md bg-gradient-to-br from-cyan-500 to-blue-500 text-[9px] font-bold text-ink">
              0
            </span>
            <span className="text-[10px] font-medium text-ink-secondary">verified claims</span>
          </div>
        </div>

        {/* Empty state */}
        <div className="rounded-xl border border-dashed border-subtle bg-gray-50 dark:bg-surface px-4 py-5 text-center">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500/10 to-blue-500/10 dark:from-cyan-500/15 dark:to-blue-500/15 flex items-center justify-center mx-auto mb-2">
            <ShieldCheck className="w-4 h-4 text-cyan-500 dark:text-brand" />
          </div>
          ...
          <Link
            href="/passport"
            className="mt-3 inline-flex items-center gap-1.5 rounded-lg bg-cyan-50 dark:bg-cyan-500/10 px-3.5 py-1.5 text-[11px] font-semibold text-cyan-600 dark:text-brand hover:bg-cyan-100 dark:hover:bg-cyan-500/20 transition-colors"
          >
            Open passport
