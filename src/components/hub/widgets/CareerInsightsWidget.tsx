    ...
    >
      <div className="space-y-2">
        {insights.map((item) => (
          ...
          >
            <span className={`w-8 h-8 rounded-lg bg-gradient-to-br ${item.gradient} flex items-center justify-center text-ink shrink-0 shadow-sm`}>
              {item.icon}
            </span>
      ...
      {/* Empty state hint */}
      <div className="mt-3 rounded-xl border border-dashed border-subtle bg-gray-50 dark:bg-surface px-4 py-4 text-center">
        <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-cyan-500/10 to-blue-500/10 dark:from-cyan-500/15 dark:to-blue-500/15 flex items-center justify-center mx-auto mb-2">
          <Sparkles className="w-4 h-4 text-cyan-500 dark:text-brand" />
        </div>
