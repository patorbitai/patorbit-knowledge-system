...
/** Corporate Blue — education-first, centered, serif accent, boxed titles */
export const CorporateBluePreview = generateTemplate({
  ...
  header: "centered",
  density: "normal",
  sectionOrder: ["summary", "education", "experience", "skills", "projects", "certs", "achievements", "languages"],
