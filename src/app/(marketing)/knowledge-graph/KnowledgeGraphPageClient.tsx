        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-4xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-ink leading-tight mb-6">Knowledge <span className="text-gradient">Graph</span></h1>
            ...
            <div className="mt-20 grid gap-8 md:grid-cols-2">
              {[
                ...
                <motion.div key={item.title} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                  className="rounded-xl border border-subtle bg-surface/60 p-8 hover:border-indigo-500/30 transition-all"
                >
            ...
            <div className="mt-16 text-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h2 className="text-3xl font-bold text-ink mb-4">Explore the graph</h2>
