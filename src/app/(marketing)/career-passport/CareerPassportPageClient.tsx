      ...
      <section className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1">
              <div className="rounded-xl border border-subtle bg-surface/60 p-8 backdrop-blur-sm">
                <div className="flex items-center gap-4 mb-8 pb-6 border-b border-line">
                  ...
                  <div>
                    <div className="text-xl font-semibold text-ink">Alex Sample</div>
                    <div className="text-sm text-ink-muted">alex@patorbit.ai · 12 verified claims</div>
                  </div>
                </div>
                {[
                  ...
                  <div key={claim.label} className="flex items-center gap-3 py-3 border-b border-line/50 last:border-0">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-xs text-ink-muted">{claim.by}</div>
                    </div>
