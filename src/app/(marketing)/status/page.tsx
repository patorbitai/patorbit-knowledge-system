      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-8">
            <h2 className="text-xl font-semibold text-white mb-1">Components we run</h2>
          ...
          <div className="mt-12 rounded-2xl border border-slate-800 bg-slate-900/60 p-8 text-center">
            ...
            <div className="flex justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-800 bg-slate-900/40 px-6 py-3 text-sm font-medium text-slate-300 transition-all duration-150 hover:bg-slate-900 hover:border-slate-700 hover:text-white"
              >
                Contact Support
              </Link>
            </div>
