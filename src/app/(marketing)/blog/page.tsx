        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="text-5xl font-bold text-white mb-6">Notes from the Patorbit team</h1>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {posts.map((post, i) => (
              <motion.div
                ...
                className="rounded-2xl border border-slate-800 bg-slate-900/60 p-8 hover:border-amber-500/30 transition-all hover:-translate-y-1 flex flex-col"
              >
          ...
          <div className="mt-16 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <h2 className="text-3xl font-bold text-white mb-4">See the product instead</h2>
