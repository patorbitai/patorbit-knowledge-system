        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="space-y-3">
            {endpoints.map((ep, i) => (
              <motion.div
                ...
                className="rounded-xl border border-slate-800 bg-slate-900/60 p-5 flex items-center gap-4 hover:border-cyan-500/30 transition-all"
              >
                <span
                ...
                <code className="text-sm text-slate-300 font-mono flex-1 break-all">{ep.path}</code>
          ...
          <div className="mt-16 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <h2 className="text-3xl font-bold text-white mb-4">Want API access?</h2>
