        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="text-5xl font-bold text-ink mb-6">Press & Media</h1>
            </motion.div>
          </div>
          <div className="mt-20 space-y-6">
            {[
              ...
              <motion.div key={a.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                className="rounded-xl border border-subtle bg-surface/60 p-8 hover:border-orange-500/30 transition-all">
                <span className="text-sm text-orange-400">{a.date}</span>
                <h2 className="text-2xl font-bold text-ink mt-2 mb-3">{a.title}</h2>
          ...
          <div className="mt-16 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-ink mb-4">Media inquiries</h2>
