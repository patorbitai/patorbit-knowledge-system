      ...
      <section className="py-24">
        <div className="mx-auto max-w-4xl px-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-16">
            <h1 className="text-5xl font-bold text-ink mb-6">Documentation</h1>
          ...
          <div className="grid gap-6 md:grid-cols-2 mb-16">
            {sections.map((section, i) => (
              <motion.div
                ...
                className="rounded-xl border border-subtle bg-surface/60 p-7 hover:border-cyan-500/30 transition-all"
              >
                ...
                <ul className="space-y-3">
                  {section.links.map((link) => (
                    <li key={link.label}>
                      <a
                        href={link.href}
                        className="text-sm text-ink-secondary hover:text-cyan-400 transition-colors flex items-center gap-2"
                      >
          ...
          <div className="space-y-12">
            {/* Quick Start */}
            <motion.div id="quick-start" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-subtle bg-surface/60 p-8 scroll-mt-28">
            ...
            {/* Claims & Evidence */}
            <motion.div id="claims" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-subtle bg-surface/60 p-8 scroll-mt-28">
              <h2 className="text-2xl font-bold text-ink mb-4">Claims &amp; Evidence</h2>
            ...
            {/* Knowledge Graph */}
            <motion.div id="knowledge-graph" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-subtle bg-surface/60 p-8 scroll-mt-28">
              <h2 className="text-2xl font-bold text-ink mb-4">Knowledge Graph</h2>
              <p className="text-sm text-ink-secondary leading-relaxed mb-3">
            ...
            {/* Trust */}
            <motion.div id="trust" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-subtle bg-surface/60 p-8 scroll-mt-28">
              <h2 className="text-2xl font-bold text-ink mb-4">Trust Signals</h2>
              <p className="text-sm text-ink-secondary leading-relaxed">
            ...
            <motion.div id="api-errors" initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="rounded-xl border border-subtle bg-surface/60 p-8 scroll-mt-28">
              <h2 className="text-2xl font-bold text-ink mb-4">API: Errors &amp; Rate Limits</h2>
          ...
          <div className="mt-16 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <h2 className="text-3xl font-bold text-ink mb-4">Ready to try it?</h2>
