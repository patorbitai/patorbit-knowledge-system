        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <h1 className="text-5xl font-bold text-ink mb-6">Join Our Team</h1>
              <p className="text-ink-secondary text-lg">Help us build the future of digital trust.</p>
            </motion.div>
          </div>
          <div className="mt-20 space-y-6">
            {jobs.map((job, i) => (
              <motion.div key={job.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}
                className="rounded-xl border border-subtle bg-surface/60 p-8 hover:border-purple-500/30 transition-all">
                <div className="flex items-center justify-between">
                  ...
                  <div className="rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-3 text-sm font-semibold text-ink">Apply</div>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-16 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-ink mb-4">Didn&apos;t find the right role?</h2>
